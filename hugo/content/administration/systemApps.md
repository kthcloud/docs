...
<img src="../../images/true_nas_create_pool.png" width="80%">
...
\
When creating the *persistent volume claim*, make sure to point the path to the NFS share you created in the previous step. You can make use of the templates provided in the repo to locate the NFS server. Please look at the other apps in the repo for examples.
